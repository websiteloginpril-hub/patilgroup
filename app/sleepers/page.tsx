    ...
    <div className="bg-white text-black">
      <div className="relative hero-section z-20">
        ...
        <div className="hidden md:block relative h-screen">
          <HLSVideo
            src="https://customer-bowidoym2wl882qb.cloudflarestream.com/859f934154420aa16fd920b0f2b6f4c2/manifest/video.m3u8"
            fallbackSrc="/1.mp4"
            autoPlay
            muted
            loop
      ...
      <div className="bg-white py-8 sm:py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          ...
          <div className="mb-8 fade-in-section">
            ...
            <h3 className="fluid-h3 font-bold text-[#F2913F] mb-8 leading-tight">Smarter, sustainable track solutions</h3>
          </div>
          ...
          <div className="space-y-4 fade-in-section">
            ...
            <div className="bg-[#F5F4F1] rounded-lg overflow-hidden">
              ...
              >
                ...
                <svg
                  className={`w-6 h-6 text-[#F2913F] transition-transform duration-300 ${expandedSections.standard ? '' : 'transform rotate-180'
                    }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
            ...
            <div className="bg-[#F5F4F1] rounded-lg overflow-hidden">
              ...
              >
                ...
                <svg
                  className={`w-6 h-6 text-[#F2913F] transition-transform duration-300 ${expandedSections.bridge ? '' : 'transform rotate-180'
                    }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
            ...
            <div className="bg-[#F5F4F1] rounded-lg overflow-hidden">
              ...
              >
                ...
                <svg
                  className={`w-6 h-6 text-[#F2913F] transition-transform duration-300 ${expandedSections.special ? '' : 'transform rotate-180'
                    }`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
