    ...
    <div className="bg-white pt-[103px]">
      ...
      <section ref={visionRef} className="bg-white py-12 sm:py-16 md:py-20 lg:py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Vision Content */}
          <div
            className={`transition-all duration-700 will-change-transform ${visionInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            style={{
      ...
      <section ref={missionRef} className="bg-white py-12 sm:py-16 md:py-20 lg:py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Mission Content */}
          <div
            className={`transition-all duration-700 will-change-transform ${missionInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            style={{
              transitionDelay: '400ms',
              transitionTimingFunction: 'cubic-bezier(0.4, 0, 0.2, 1)',
      ...
      <section ref={coreValuesRef} className="bg-black py-12 sm:py-16 md:py-20 lg:py-24 relative">
        ...
        <div
          className={`absolute h-3 sm:h-5 lg:h-7 transition-all duration-1000 will-change-transform ${coreValuesInView ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'
            }`}
          style={{
            top: '0px',
            left: '0px',
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Core Values Heading */}
          <div
            className={`text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20 transition-all duration-700 will-change-transform ${coreValuesInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
            style={{
              transitionDelay: '100ms',
              transitionTimingFunction: 'cubic-bezier(0.4, 0, 0.2, 1)',
          ...
          <div className="text-center">
            ...
            <div className="block sm:hidden space-y-4">
              {['Quality', 'Customer Centric', 'Human Centric', 'Innovative', 'Sustainable growth', 'Adaptive', 'Competitive'].map((value, index) => (
                <div
                  key={value}
                  className={`inline-block px-4 py-2 sm:px-6 sm:py-3 text-white text-sm sm:text-base font-semibold shadow-lg will-change-transform ${coreValuesInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                    }`}
                  style={{
            ...
            <div className="hidden sm:block">
              ...
              <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8">
                {['Quality', 'Customer Centric', 'Human Centric', 'Innovative'].map((value, index) => (
                  <div
                    key={value}
                    className={`px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 text-white text-base sm:text-lg md:text-xl lg:text-2xl font-semibold shadow-lg will-change-transform ${coreValuesInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                      }`}
                    style={{
                      background: activeValueIndex === index
                        ? '#F2913F'
