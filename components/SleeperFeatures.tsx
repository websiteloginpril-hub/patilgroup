...
const featureData = [
  {
    ...
    description: 'Patil Group has developed advanced concrete sleepers, crafted as a durable and sustainable alternative to steel channel sleepers typically used on girder bridges.',
  },
  {
    title: 'Improved Sleeper Durability',
  ...
  {
    title: 'Future-Ready for Higher Axle Loads',
    description: "With the rise in rail traffic and the growing need for higher-speed corridors, concrete sleepers have emerged as the preferred solution due to their long service life, reduced maintenance needs, and structural stability.",
  },
  {
    title: 'Extensive Manufacturing Network',
    description: "Their adoption is steadily increasing across India and global markets, reinforcing Patil Group's commitment to innovation and quality in rail infrastructure.",
  },
];
...
export default SleeperFeatures; 